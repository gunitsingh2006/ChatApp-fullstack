...
import { getMyFriends, getRecommendedUsers,sendFriendRequest, acceptFriendRequest , getFriendRequests, getOutgoingFriendRequests, } from '../controller/user.controllerr.js';
...
router.post("/friend-requests/:idx", protectRoute , sendFriendRequest);
router.put("/friend-requests/:idx/accept", protectRoute , acceptFriendRequest);
