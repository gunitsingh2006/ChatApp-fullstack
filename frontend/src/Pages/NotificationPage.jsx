            ...
            {incomingRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  ...
                  Friend Requests
                  <span className="badge badge-primary ml-2 btn-circle ">
                ...
                <div className="space-y-3">
                  {acceptedRequests.map((notification) => (
                    <div
                      ...
                      className="card  bg-base-200 rounded-2xl shadow-sm"
                    >
                      <div className="card-body p-4 ">
                        <div className="flex items-start rounded gap-3">
                          <div className="avatar mt-1 size-10 rounded-full btn-circle">
                            <img
                              className="rounded-full"
                              src={notification.recipient.pfp}
                              alt={notification.recipient.fullName}
                            />
                          </div>
                          <div className="flex-1">
                            <h2 className="font-semibold">
                              {capitialize(notification.recipient.fullName)}
                            </h2>
